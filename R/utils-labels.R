...
var_labels <- c(
  ...
  "nnt_positive"             = "HIV NNT (positive NIA only)",
  "pct_nia"                  = "Proportion of simulation with HIV NIA > 0",
  "nnt_hiv_sti_positive"     = "HIV NNT - per STI test (positive NIA only)",
  "nnt_gc_positive"          = "GC NNT (positive NIA only)",
  "pct_nia_gc"               = "Proportion of simulation with GC NIA > 0",
  "nnt_gc_hivpos_positive"   = "GC NNT - HIV positive (positive NIA only)",
  "pct_nia_gc_hivpos"        = "Proportion of simulation with GC NIA > 0 (HIV positive)",
  "nnt_gc_hivneg_positive"   = "GC NNT - HIV negative (positive NIA only)",
  "pct_nia_gc_hivneg"        = "Proportion of simulation with GC NIA > 0 (HIV negative)",
  "nnt_ct_positive"          = "CT NNT (positive NIA only)",
  "pct_nia_ct"               = "Proportion of simulation with CT NIA > 0",
  "nnt_ct_hivpos_positive"   = "CT NNT - HIV positive (positive NIA only)",
  "pct_nia_ct_hivpos"        = "Proportion of simulation with CT NIA > 0 (HIV positive)",
  "nnt_ct_hivneg_positive"   = "CT NNT - HIV negative (positive NIA only)",
  "pct_nia_ct_hivneg"        = "Proportion of simulation with CT NIA > 0 (HIV negative)",
