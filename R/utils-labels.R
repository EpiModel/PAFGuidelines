...
var_labels <- c(
  ...
  "ir100_gc_hivpos"          = "GC Incidence Rate - HIV positive",
  "ir100_gc_hivneg"          = "GC Incidence Rate - HIV negative",
  "ir100_ct"                 = "CT Incidence Rate",
  "ir100_ct_hivpos"          = "CT Incidence Rate - HIV positive",
  "ir100_ct_hivneg"          = "CT Incidence Rate - HIV negative",
  ...
  "gc_prev_hivpos"           = "GC Prevalence - HIV positive",
  "gc_prev_hivneg"           = "GC Prevalence - HIV negative",
  "ct_prev"                  = "CT Prevalence",
  "ct_prev_hivpos"           = "CT Prevalence - HIV positive",
  "ct_prev_hivneg"           = "CT Prevalence - HIV negative",
