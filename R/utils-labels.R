...
var_labels <- c(
  ...
  "cum_incid_gc_hivpos"      = "GC Cumulative incidence - HVI positive",
  "cum_incid_ct_hivpos"      = "CT Cumulative incidence - HVI positive",
  "cum_incid_gc_hivneg"      = "GC Cumulative incidence - HVI negative",
  "cum_incid_ct_hivneg"      = "CT Cumulative incidence - HVI negative",
  "nia"                      = "HIV NIA",
  "nia_gc"                   = "GC NIA",
  "nia_ct"                   = "CT NIA",
  "pia"                      = "HIV PIA",
  ...
  "cum_incid_gc_hivpos_diff" = "GC Cumulative incidence - HVI positive - Diff",
  "cum_incid_ct_hivpos_diff" = "CT Cumulative incidence - HVI positive - Diff",
  "cum_incid_gc_hivneg_diff" = "GC Cumulative incidence - HVI negative - Diff",
  "cum_incid_ct_hivneg_diff" = "CT Cumulative incidence - HVI negative - Diff"
)
